...
| psycopg[binary] | 3.3.5 (under evaluation) | LGPL-3.0-only | Worker-side PostgreSQL boundary | Do not adopt until the worker-safe contract passes and LGPL distribution review is accepted; retain asyncpg for SQLAlchemy/migration paths |
