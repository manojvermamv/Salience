...
[Original historical evidence](<archive/2026-09-22/docs/trust-model.md.snapshot>) is retained with its inventory hash. It is superseded source text, not a current execution plan.
