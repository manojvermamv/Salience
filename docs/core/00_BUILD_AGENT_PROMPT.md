...
[Original historical evidence](<../archive/2026-09-22/docs/core/00_BUILD_AGENT_PROMPT.md.snapshot>) is retained with its inventory hash. It is superseded source text, not a current execution plan.

<!-- Historical heading anchors retained for incoming links. -->
<a id="build-agent-prompt"></a>
